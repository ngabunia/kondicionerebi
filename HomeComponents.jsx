...
const TeamBlock = () => (
  <section className="kg-section">
    <div className="kg-team-block">
      ...
      <div>
        <h2>ვინ ვართ ჩვენ</h2>
        <p>ჩვენ ვართ ოთხი ადამიანის გუნდი მეგატექნიკას ექსპერტიზის ცენტრიდან. ერთად ჩვენ გვაქვს 20+ წლის გამოცდილება კონდიციონერების მონტაჟის, სერვისისა და გაყიდვის სფეროში.</p>
        ...
        <a href="#" className="kg-team-link">სრული მეთოდოლოგია <IconChevR size={12}/></a>
      </div>
    </div>
  </section>
);
